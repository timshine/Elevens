 ...
 ************************************************************************
 * This is the original AP Elevens Lab Java program code. 03-30-15 slightly
 * altered by Leon Schram who likes curly braces aligned.
 *************************************************************************
 * This is the student, starting file of Experiment03.
 */
public class ElevensBoard {
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
		...
		for (int k = 0; k < selectedCards.size(); k++) {
			sum += cards[selectedCards.get(k)].pointValue();
			choices ++;
		}
